...
# Script to encode conditions-lens.js to base64 and update conditions-lens.json

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
PROJECT_DIR="$(dirname "$SCRIPT_DIR")"

JS_FILE="$PROJECT_DIR/conditions-lens.js"
JSON_FILE="$PROJECT_DIR/conditions-lens.json"
...
console.log('✅ Updated conditions-lens.json with encoded JS');
"
